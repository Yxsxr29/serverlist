...
- `/spectate string:madrazo` erstellt eine dauerhaft aktualisierte Nachricht mit passenden Online-Spielern und meldet Statuswechsel (online/offline) einmalig
